...
# Explain.
# I used a string for first_name, a boolean for is_hungry and an integer for number_of_pets
...
# Did you run this file in your terminal to make sure everything printed out to the terminal
  # as you would expect?
# yes it did, and I ran it several times along the way to make sure I was doing it right.
